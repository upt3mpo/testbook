...
The most common ways these principles get violated in practice — testing implementation details instead of behavior, over-complicated setup, and cramming multiple behaviors into one test — are covered with more examples in [Testing Anti-Patterns](TESTING_ANTIPATTERNS.md), rather than repeated here.
