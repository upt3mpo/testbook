...
#
# Unit tests for database models are ESSENTIAL because:
#
# 1. **Data Integrity** - Models define how data is stored and related
# 2. **Relationship Validation** - Tests verify foreign keys, cascades, and joins work correctly
# 3. **Constraint Enforcement** - Unique constraints, required fields, data types
# 4. **Cascade Behavior** - Critical for data cleanup (deleting user should delete their posts)
#
# What These Tests Catch:
# - ✅ Broken relationships (can't access post.author or user.posts)
# - ✅ Missing cascade deletes (orphaned data in database)
# - ✅ Unique constraint violations (duplicate emails/usernames)
# - ✅ Many-to-many relationship issues (followers, blocking)
# - ✅ Default value problems (profile pictures, timestamps)
#
# In Real QA Teams:
# - Model tests prevent database migrations from breaking existing code
# - They document database schema and relationships
# - Failed model tests indicate schema design issues
# - They're the foundation for all higher-level tests
#
# For Your Career:
# - Shows you understand database design (foreign keys, indexes, cascades)
# - Demonstrates knowledge of ORMs (SQLAlchemy patterns)
# - Interview question: "How would you test database relationships?" - Point to these!
# - Proves you think about data integrity and cleanup
